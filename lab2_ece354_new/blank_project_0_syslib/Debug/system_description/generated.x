 ...
 * C:\Users\tbadams\Desktop\GitPortable\Data\home\ece354\lab2_ece354_new\system_0.ptf
 *
 * Generated: 2016-02-16 15:35:39.682
 *
 */
...
MEMORY
{
    reset : ORIGIN = 0x00600000, LENGTH = 32
    cfi_flash_0 : ORIGIN = 0x00000000, LENGTH = 4194304
    epcs_controller : ORIGIN = 0x00680800, LENGTH = 2048
    ssram : ORIGIN = 0x00600020, LENGTH = 524256
}

    /* Define symbols for each memory base-address */
 __alt_mem_cfi_flash_0 = 0x00000000 ;
 __alt_mem_epcs_controller = 0x00680800 ;
 __alt_mem_ssram = 0x00600000 ;
...
SECTIONS
{
    ...
    .text :
    {
        ...
        *(.dynamic)
        ...
        KEEP (*(.jcr))
        . = ALIGN(32 / 8);
    } >  ssram =0x3a880100 /* NOP on Nios2 (big endian) */
    ...
    .epcs_controller : AT (LOADADDR (.cfi_flash_0) + SIZEOF (.cfi_flash_0))
    {
    ...
    .ssram LOADADDR (.epcs_controller) + SIZEOF (.epcs_controller): AT (LOADADDR (.epcs_controller) + SIZEOF (.epcs_controller))
    {
...
PROVIDE( __alt_heap_limit    = 0x00680000 );
